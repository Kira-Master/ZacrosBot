...
cmd.on("ownerr",["ownerbot","owner"],["other"],async(msg,res) => {
	client.sendMessageFromContent(msg.from, {contactsArrayMessage: {
				"displayName": "Owner/Contributor Bot",
				  "contacts": [
				   {
					 	"displayName": "KiraMaster",
						"vcard": "BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:KiraMaster\nitem1.TEL;waid=6282322153431:6283153448697\nitem1.X-ABLabel:Owner Bot\nEND:VCARD"
					 }
					 ],
				   }}, {quoted:msg})
	});
...
*- For Owner* 
Shoopepay : 082322153431
Pulsa : 082322153431
Ovo/Dana/Gopay : Scan QRIS Profile
*- For Contributor*
Dana : Scan QR (Kira-Master)
Gopay : Scan QR (Kira-Master)
Saweria : https://saweria.com/fauzimatsukio
