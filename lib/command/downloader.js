...
let etto = await functions.axios.get(`https://zacrosapi.herokuapp.com/downloader/igdl?link=${query}`)
let anu = etto.data.link
await client.sendText(msg.from,'Tunggu sebentar ya..',msg)
return client.sendMessage(msg.from,(await client.getBuffer(anu.link)).buffer,'videoMessage',{caption:`Nih`,quoted:msg})
